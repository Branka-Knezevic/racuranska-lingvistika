...
broj_karaktera=len(priča)
print(broj_karaktera)
zadnja="Nikad više nisu se svađale koja najlepše peva."
broj_karaktera_u_zadnjoj=len(zadnja)
print(broj_karaktera_u_zadnjoj)
priča1=priča[0:1207]
print(priča1)
nastavak="Sutradan su se žabe, prijateljice preminulih, odlučile na osvetu. Odlučile su da ponovo organizuju takmičenje. Ovoga puta je ono bilo zamka za zločince koji su pojeli njihove prijateljice. Kako su roda, zmija i patka ne razmišljajući odlučile da budu u žiriju, ne znajući da na taj način upadaju direktno u zamku."
cela_priča=priča+" "+nastavak
print(cela_priča)
broj_rečenica=cela_priča.split(". ")
print(broj_rečenica)
n_rečenica=len(broj_rečenica)
print(n_rečenica)